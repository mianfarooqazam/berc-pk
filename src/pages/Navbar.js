    ...
    <nav className="fixed top-0 left-0 w-full bg-white shadow-md z-10">
      <div className="flex items-center justify-between p-4">
        ...
        <ul className="flex space-x-8">
          ...
          <li>
            <a href="#why-us" className="text-lg font-semibold text-gray-700">Why Us</a>
          </li>
          <li>
            <a href="#tools" className="text-lg font-semibold text-gray-700">Tools</a>
          </li>
          <li>
            <a href="#services" className="text-lg font-semibold text-gray-700">Services</a>
          </li>
          <li>
