...
const tools = [
  ...
  { name: 'BPD (Building Performance Design) Tool', description: '(Building Performance Design) Tool for Pakistan, developed at BERC UET Peshawar, is an energy performance evaluation tool designed to store and manage building energy information. It enables government bodies and accredited assessors to access and utilize energy data for comprehensive analysis. The tool key features include building energy modeling and simulation to calculate the Energy Usage Index (EUI) for various buildings.' },
